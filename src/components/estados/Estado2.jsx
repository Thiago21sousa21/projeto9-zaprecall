    ...
    return(
                <CsEstado2>
                  ...
                  <div className="alinhaButtonEstado2">
                    <button data-test="no-btn" onClick={()=>setaPro3(erro, 'red', "no-icon")} className="red">Não lembrei</button>
                    <button data-test="partial-btn" onClick={()=>setaPro3(quase, 'orange', "partial-icon")} className="orange" >Quase não lembrei</button>
                    <button data-test="zap-btn" onClick={()=>setaPro3(certo, 'green', "zap-icon")} className="green" >Zap!</button>
                  </div>
                 </CsEstado2>
    )
  }

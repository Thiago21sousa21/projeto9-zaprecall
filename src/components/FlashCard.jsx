...
export default function FlashCard(props){
    ...
    function verificaRetorna(){
      if( estado == 0 ){
        ...
        return <Estado2 setBackground={setBackground} setManipulado={setManipulado} data={data} indice={indice} setEstado={setEstado} setAltura={setAltura} setIcon={setIcon} setCor={setCor} setCont={setCont} cont={cont}/>
      } else {
